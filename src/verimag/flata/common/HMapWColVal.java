...
/**
 * Generic class for the HashMap data structure which contains a collection objects as its values.
...
//HashMapWithCollectionValues
public class HMapWColVal<E,K,V extends Collection<E>> extends HashMap<K, V> {

	Class<V> valueClass;
	public HMapWColVal(Class<V> aValueClass) {
